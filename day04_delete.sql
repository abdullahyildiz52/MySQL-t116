...
savepoint cilek; -- olusturdugumuz yrni bir alana database imizin bir kopyasini olusturduk
rollback to cilek; -- bu satirda ise yaptigimiz degisikleikleri savepaoint den geri cagirmakiicin kullndik
